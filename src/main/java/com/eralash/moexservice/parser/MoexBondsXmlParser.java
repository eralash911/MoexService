...
import com.eralash.moexservice.exeption.BondParsingException;
...
@Component
@Slf4j
public class MoexBondsXmlParser implements Parser{
    @Override
    public List<BondDto> parser(String ratesAsString) {
